...
def my_datetime(num_sec):
    ...
    for year in range(0, 9999):
        ...
        if is_leap_year(actual_year):
            for month in calendar_leap:
                ...
                count_month += 1
                day, count_day = day_looper(month, count_month, count_day, num_days)
    ...
    return str(count_month).zfill(2) + "-" + str(day).zfill(2) + "-" + str(actual_year)
